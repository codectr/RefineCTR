...
class CriteoDataset(torch.utils.data.Dataset):
    ...
    def __read_train_all_feats(self):
        return pickle.load(open(self.prefix + "train_all_feat811.pkl", "rb"))
    ...
    def __get_feat_mapper(self, path):
        ...
        f = open(self.prefix + "train_all_feat811.pkl", "wb")
...
def get_criteo_811(train_path="train.txt", batch_size=2048):
...
"""
the full data: train.txt, which contains over 45,000,000 simple, 13 numerical features and 26 categorical feature
