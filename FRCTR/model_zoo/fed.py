...
from FRCTR.common import FeaturesEmbedding, MultiLayerPerceptron, FactorizationMachine

class FED(nn.Module):
    def __init__(self, field_dims, embed_dim, mlp_layers=(400, 400, 400), drm_flag=True, dropout=0.5):
